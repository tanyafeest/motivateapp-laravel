<div>
    ...
    <!-- purple -->
    <div id="step6" class="flex flex-col {{ $currentMStep != 6 ? 'hidden' : '' }} {{ $currentStep != 6 ? 'lg:hidden' : 'lg:block' }} items-center h-screen relative" style="background: linear-gradient(146.67deg, #7A5CDC 1.12%, #AF55D8 122.75%);">
