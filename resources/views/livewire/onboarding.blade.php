<div>
    ...
    <div id="step1" class="lg:hidden bg-sky-300 h-screen relative {{ $currentMStep != 1 ? 'hidden' : '' }}">
        <img class="z-10 lg:hidden" src=" {{ asset('images/howitworks.png') }} " alt=""> 
        <img class="z-20 lg:hidden absolute top-24 w-[120px] left-[145px]" src=" {{ asset('images/mm-logo.png') }}" alt="">
